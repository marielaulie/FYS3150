...
void Brute_MonteCarlo(int n, double a, double b, double  &integral, double  &std){
        ...
        uniform_real_distribution<double> RandomNumberGenerator_T(0.0,pi);
        uniform_real_distribution<double> RandomNumberGenerator_P(0.0,2*pi);
        ...
        for (i = 0; i < n; i++){
                ...
                y1=RandomNumberGenerator_T(gen)*(b-a)+a;
                y2=RandomNumberGenerator_T(gen)*(b-a)+a;
                z1=RandomNumberGenerator_P(gen)*(b-a)+a;
                z2=RandomNumberGenerator_P(gen)*(b-a)+a;
